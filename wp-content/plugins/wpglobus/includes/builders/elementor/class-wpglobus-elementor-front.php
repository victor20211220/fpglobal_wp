...
if ( ! class_exists( 'WPGlobus_Elementor_Front' ) ) :
	...
	class WPGlobus_Elementor_Front {
		...
		/**
		 * Var $elementor_edit_mode_meta_key
		 *
		 * @since 2.4.12
		 */
		...
		/**
		 * Var $post_elementor_support_meta_key
		 *
		 * @since 2.4.12
		 */
		...
		public static function init( $attrs ) {
			 ...
			 * @since 2.5.5
			 */
			add_action( 'elementor/frontend/after_enqueue_styles', array(
				__CLASS__,
			 ...
			 * @since 2.3.6
			 */
			add_filter( 'wpglobus_plus_publish_template_include_handler', array(
				__CLASS__,
				'filter__template_include_handler',
			) );
		...
		public static function frontend_before_enqueue_styles() {
			...
			if ( $kit ) {
				...
				/**
				 * W.I.P `enqueue` doesn't work here.
				 *
				 * @since 2.5.5
		...
		public static function filter__elementor_files_file_name( $file_name, $instance ) {
			...
			/**
			 * W.I.P Maybe check out for global post ID.
			 *
			 * @since 2.3.3
			 * //global $post;
		...
		public static function filter__template_include_handler( $handler ) {
			 ...
			 * W.I.P
			 *
			 * @since 2.4.12 Do we need to check is_builder_support?
			 * //if ( ! self::is_builder_support() ) {
			 * //return $handler;
			 * //}
			 */
			 ...
			 */
			if ( ! WPGlobus_WP::get_http_get_parameter( 'elementor-preview' ) ) {
				return $handler;
			}
