...
if ( ! class_exists( 'WPGlobus_Customize_Options' ) ) :
	 ...
	 * @see wp-includes/class-wp-customize-control.php
	 */
	class WPGlobusCheckBox extends WP_Customize_Control { // phpcs:ignore
	 ...
	 * @see wp-includes/class-wp-customize-control.php
	 */
	class WPGlobusLink extends WP_Customize_Control { // phpcs:ignore
	 ...
	 * @see wp-includes/class-wp-customize-control.php
	 */
	class WPGlobusCheckBoxSet extends WP_Customize_Control { // phpcs:ignore
	 ...
	 * @see wp-includes/class-wp-customize-control.php
	 */
	class WPGlobusFieldsSettingsControl extends WP_Customize_Control { // phpcs:ignore
	 ...
	 */
	class WPGlobus_Customize_Options { // phpcs:ignore
